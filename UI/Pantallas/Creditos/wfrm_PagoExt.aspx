<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfrm_PagoExt.aspx.cs" Inherits="UI.Pantallas.Creditos.wfrm_PagoExt" %>
...
<head runat="server">
    ...
    <title>Créditos - Pago Extraordinario</title>
        ...
        <div id="main">
            ...
            <header>
                <div id="encabezado">
                    ...
                    <div class="titulo">
                        <h1>Realizar pago extraordinario</h1>
                    </div>
                    <div class="salir">
